...
/* ======================================================================== */
LOCAL const uint_32 stic_color_mask[16]  =
{
...
/*            const uint_32 csq0_color = stic_color_mask[csq0];
            ...
            const uint_32 csq0_color=0;
            const uint_32 csq1_color = 0;
            const uint_32 csq2_color = 0;
            const uint_32 csq3_color = 0;
